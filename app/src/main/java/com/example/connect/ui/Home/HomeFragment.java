...
import com.example.connect.Common.EndlessRecyclerViewScrollListener;
...
*/
    ...
    public void showPosts(){
        ...
        homeViewModel.getAllPostList().observe(getViewLifecycleOwner(), postModels -> {
    ...
    public void showInterest(){
        homeViewModel.getAllUserInterestList().observe(getViewLifecycleOwner(), userInterestModels -> {

            Common.userInterestList.clear();
            for (int i = 0; i < userInterestModels.size(); i++) {
                    Common.userInterestList.add(userInterestModels.get(i).getName());
            }
        });
    }
